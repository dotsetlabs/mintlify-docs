...
**Preflight** is an infrastructure smoke-testing tool integrated into the Dotset CLI. While existing tools (like Zod or Envalid) check your **types**, Preflight checks your **connections**.
