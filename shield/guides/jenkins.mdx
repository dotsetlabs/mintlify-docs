...
pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
                sh 'dotset shield run --mode redact -- npm test'
            }
        }
    }
}
...
Shield auto-detects environment variables from [Jenkins credentials](https://www.jenkins.io/doc/book/using/using-credentials/):
        ...
        stage('Deploy') {
            steps {
                withCredentials([
                    ...
                    sh 'dotset shield run --mode redact -- ./deploy.sh'
                }
            }
        }
    }
        ...
        stage('Deploy') {
            ...
            steps {
                withCredentials([
                    ...
                    sh 'dotset shield run --mode redact -- ./scripts/deploy.sh'
                }
            }
        }
    }
