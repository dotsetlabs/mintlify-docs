...
Shield comes pre-configured with a curated set of high-accuracy detection patterns for common secret types:
...
In addition to pattern-based detection, Shield also performs:
...
If a value matches multiple patterns, Shield:
