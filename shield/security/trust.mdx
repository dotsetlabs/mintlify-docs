...
<Tip>
You can verify this yourself by reading [telemetry.ts on GitHub](https://github.com/dotsetlabs/cli/blob/main/src/telemetry.ts#L34).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Audit Telemetry" icon="magnifying-glass" href="https://github.com/dotsetlabs/cli/blob/main/src/telemetry.ts">
