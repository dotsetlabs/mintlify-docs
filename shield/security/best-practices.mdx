...
Shield will automatically detect and protect these environment variables.
...
```bash
dotset shield run --mode redact --quiet -- npm test
```
...
dotset shield run --mode detect -- npm start
```
