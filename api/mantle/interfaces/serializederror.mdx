...
description: "Defined in: src/mantle/errors/index.ts:126"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / SerializedError

# Interface: SerializedError

Defined in: src/mantle/errors/index.ts:126
