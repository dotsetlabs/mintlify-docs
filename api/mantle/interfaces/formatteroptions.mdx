...
description: "Defined in: src/mantle/output/formatters.ts:88"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / FormatterOptions

# Interface: FormatterOptions

Defined in: src/mantle/output/formatters.ts:88
