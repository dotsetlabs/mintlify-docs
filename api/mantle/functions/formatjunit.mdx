---
title: "Function: formatJUnit"
description: "```ts"
icon: "function"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / formatJUnit

# Function: formatJUnit()

```ts
function formatJUnit(result, options): string;
```

Defined in: src/mantle/output/formatters.ts:262
