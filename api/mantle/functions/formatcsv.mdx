---
title: "Function: formatCSV"
description: "```ts"
icon: "function"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / formatCSV

# Function: formatCSV()

```ts
function formatCSV(result, options): string;
```

Defined in: src/mantle/output/formatters.ts:122
