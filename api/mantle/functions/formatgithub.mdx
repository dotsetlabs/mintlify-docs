---
title: "Function: formatGitHub"
description: "```ts"
icon: "function"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / formatGitHub

# Function: formatGitHub()

```ts
function formatGitHub(result, _options): string;
```

Defined in: src/mantle/output/formatters.ts:760
