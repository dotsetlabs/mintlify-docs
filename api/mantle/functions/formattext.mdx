---
title: "Function: formatText"
description: "```ts"
icon: "function"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / formatText

# Function: formatText()

```ts
function formatText(result, options): string;
```

Defined in: src/mantle/output/formatters.ts:909
