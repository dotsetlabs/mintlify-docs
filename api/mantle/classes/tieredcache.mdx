...
description: "Defined in: src/mantle/utils/cache.ts:568"
icon: "cube"
---

[Dotset CLI API Documentation](/api) / [index](/api/mantle) / TieredCache

# Class: TieredCache\<K, V\>

Defined in: src/mantle/utils/cache.ts:568
