...
description: "Defined in: src/shield/utils/profiler.ts:20"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / OperationStats

# Interface: OperationStats

Defined in: src/shield/utils/profiler.ts:20
