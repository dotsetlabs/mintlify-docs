...
description: "Defined in: src/shield/errors/index.ts:998"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / ResilientOptions

# Interface: ResilientOptions

Defined in: src/shield/errors/index.ts:998
...
Defined in: src/shield/errors/index.ts:999
...
Defined in: src/shield/errors/index.ts:1000
...
Defined in: src/shield/errors/index.ts:1001
