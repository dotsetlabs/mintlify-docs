...
description: "Defined in: src/shield/output/formatters.ts:37"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / Finding

# Interface: Finding

Defined in: src/shield/output/formatters.ts:37
