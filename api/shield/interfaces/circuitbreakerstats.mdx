...
description: "Defined in: src/shield/errors/index.ts:735"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / CircuitBreakerStats

# Interface: CircuitBreakerStats

Defined in: src/shield/errors/index.ts:735
