...
description: "Defined in: src/shield/utils/profiler.ts:34"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / MemorySnapshot

# Interface: MemorySnapshot

Defined in: src/shield/utils/profiler.ts:34
