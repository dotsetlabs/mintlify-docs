...
description: "Defined in: src/shield/utils/profiler.ts:180"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / ProfilerOptions

# Interface: ProfilerOptions

Defined in: src/shield/utils/profiler.ts:180
