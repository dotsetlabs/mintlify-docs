...
description: "Defined in: src/shield/utils/profiler.ts:53"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / ProfileSummary

# Interface: ProfileSummary

Defined in: src/shield/utils/profiler.ts:53
