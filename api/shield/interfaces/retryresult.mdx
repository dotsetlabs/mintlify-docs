...
description: "Defined in: src/shield/errors/index.ts:566"
icon: "brackets-curly"
---

[Dotset CLI API Documentation](/api) / [index](/api/shield) / RetryResult

# Interface: RetryResult\<T\>

Defined in: src/shield/errors/index.ts:566
