  ...
  test:
    ...
    steps:
      ...
      - run:
          ...
          command: dotset mantle run --mode redact -- npm test
  ...
  deploy:
    ...
    steps:
      ...
      - run:
          ...
          command: dotset mantle run --mode redact -- ./deploy.sh
...
<Note>
Create a `dotset-mantle` context with your `DOTSET_API_TOKEN` for analytics tracking.
</Note>
...
jobs:
  ...
  deploy:
    ...
    steps:
      ...
      - run:
          name: Deploy with protection
          command: dotset mantle run --mode redact -- ./scripts/deploy.sh
