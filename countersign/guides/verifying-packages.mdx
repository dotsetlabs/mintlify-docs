...
Trust Score Breakdown:
  ...
  │    ├─ Source: github.com/example/mcp-server
  │    └─ Build attestation: Missing
  └─ Package Hygiene         8/15
       ├─ Dependencies: 5
       └─ Install scripts: Yes (postinstall)

Overall: 78/100 (MEDIUM) 🟡

Package Analysis:
  ├─ postinstall script found - review recommended
  └─ 5 dependencies (2 with known vulnerabilities)
```
...
✗ Trust score 65 below threshold 80
```
