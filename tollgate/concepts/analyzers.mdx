...
| `prompt-injection` | Security guardrail | All string arguments |

<Note>
The `prompt-injection` analyzer is typically used via the [guardrails](/tollgate/concepts/guardrails) configuration rather than as a policy analyzer.
</Note>
