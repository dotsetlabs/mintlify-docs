...
When your project is [linked to the cloud](/cli/link), Shield automatically syncs your security policies:
...
To use custom regex patterns or disable specific default rules, you must [link your project](/cli/link) to the Cloud. When linked, the CLI fetches your project-specific policies from the Dashboard, which completely override the local defaults.

See the [Security Policies](/concepts/security-policies) guide for a full list of default patterns.
